...
# The original seven-item navigation. Every project route marks Projects current,
# including the data and person pages added by the project rework.
CURRENT = {
    "/": "Home", "/about/": "About", "/projects/": "Projects",
    "/publications/": "Publications", "/visualizations/": "Visualizations",
...
with Browser() as b:
    ...
    check(p.locator("header nav a").count() == 7, "navigation is unchanged at seven items")
